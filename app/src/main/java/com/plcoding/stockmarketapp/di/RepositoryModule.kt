...
import com.plcoding.stockmarketapp.data.repository.StrockRepositoryImpl
...
abstract class RepositoryModule {
    ...
    ): CVSParser<CompanyListing>

    @Binds
    @Singleton
    abstract fun bindsIntradayInfoParser(
        intradayInfoParser: IntradayInfoParser
    ): CVSParser<IntradayInfo>


    @Binds
    @Singleton
    abstract fun bindStockRepository(
        stockRepositoryImpl: StrockRepositoryImpl
    ): StockRepository
